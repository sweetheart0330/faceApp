...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(941, 411)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.img = QtWidgets.QLabel(self.centralwidget)
        self.img.setGeometry(QtCore.QRect(220, 10, 351, 351))
        ...
        self.makeUp.setGeometry(QtCore.QRect(10, 70, 201, 91))
        self.makeUp.setObjectName("makeUp")
        self.eyesCheck = QtWidgets.QCheckBox(self.makeUp)
        self.eyesCheck.setGeometry(QtCore.QRect(0, 10, 61, 17))
        self.eyesCheck.setObjectName("eyesCheck")
        self.lipsCheck = QtWidgets.QCheckBox(self.makeUp)
        ...
        self.eyesColorShower.setStyleSheet("border-top-left-radius: 50px;")
        ...
        self.chbCheck = QtWidgets.QCheckBox(self.makeUp)
        self.chbCheck.setGeometry(QtCore.QRect(0, 70, 61, 17))
        self.chbCheck.setObjectName("chbCheck")
        self.buttonProcess = QtWidgets.QPushButton(self.centralwidget)
        self.buttonProcess.setGeometry(QtCore.QRect(130, 180, 75, 23))
        self.buttonProcess.setObjectName("buttonProcess")
        self.imgPostProcess = QtWidgets.QLabel(self.centralwidget)
        self.imgPostProcess.setGeometry(QtCore.QRect(580, 10, 351, 351))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
